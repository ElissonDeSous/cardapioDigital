...
import pedidos from '../controllers/pedidos/pedidosController.js'
...
// rotas pedidos
rotas.post('/pedido', Autenticado, pedido.criarPedidos)
rotas.delete('/pedido/:id', Autenticado,pedido.deletarPedido)
